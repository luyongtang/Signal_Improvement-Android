...
import org.thoughtcrime.securesms.SignalServiceReactionMessage;
...
public class SendReactReceiptJob extends ContextJob implements InjectableType {

    private static final long serialVersionUID = 1L;

    private static final String TAG = SendReactReceiptJob.class.getSimpleName();
    ...
    public SendReactReceiptJob(@NonNull Context context, @NonNull WorkerParameters workerParameters) {
        super(context, workerParameters);
    }

    public SendReactReceiptJob(Context context, Address address, List<Long> messageIds) {
    ...
    public void onRun() throws IOException, UntrustedIdentityException {
        ...
        SignalServiceReceiptMessage receiptMessage = new SignalServiceReactionMessage(messageIds, timestamp,":)");
